        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">ตรวจสอบข้อมูลอนุมัติขอสอบ</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="index.php">หน้าหลัก</a></li>
                        <li class="breadcrumb-item active">ตารางข้อมูลอนุมัติขอสอบ</li>
                    </ol>
                    <?php 
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table mr-1"></i> ตารางข้อมูลอนุมัติขอสอบ
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr align="center" >
                                        ...
                                        <td><?php   
                                            if ($row["Pro_final"] == 2){
                                                ...
                                                echo "<a type='button' class='btn btn-warning' href='page/edit/edit_exam_project.php?ID=" . $row["Pro_id"] . "&P=" . $row["P_id"]."'> กำหนด </a> </a>";
                                            ?>
                                                <!-- echo "<a type='button' class='btn btn-danger' href='page/delete/delete_exam_project.php?ID=" . $row["Pro_id"] ."'> ยกเลิก </a> </a>"; -->
                                                <a href="JavaScript:if(confirm('คุณต้องการลบข้อมูลยื่นคำร้องขอสอบ ?')==true){window.location='page/delete/delete_exam_project.php?ID=<?php echo $row["Pro_id"];?>';}" type='button' class='btn btn-danger'>ยกเลิก</i></a>
                                            <?php }
                                            ?>
                                        </td>
                                        <!-- <td>
                                            <a type="button" class="btn btn-warning" href="page/edit/edit_exam_project.php?ID=<?php echo $row["Pro_id"];?>&P=<?php echo $row["P_id"];?>">กำหนด</a>
