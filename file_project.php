        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>ส่งเอกสารโครงงาน</h4>
              <h2>ส่งเอกสารโครงงาน</h2>
            </div>
          </div>
        </div>
      </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table mr-1"></i> Google Drive
                        </div>
                        <form  name="add_project" action="upload.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <?php while($row = mysqli_fetch_array($objQuery)){?>
                                    <a>ลิ้งค์ส่งงาน</a></br>
                                <a href="<?php echo $row["Upload"]; ?>"></br><?php echo $row["Upload"]; ?>
                                <img src="img/Logo-Google.png" width="200"  height="400">
                                </a>
                                <?php } ?>
                                </div>
                                </div>
